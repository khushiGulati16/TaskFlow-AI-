    ...
    return (
        <div className="min-h-screen bg-[#1e1e2d] flex items-center justify-center p-4">
            <motion.div 
                ...
                className="max-w-md w-full glass p-8 rounded-3xl border border-white/10"
            >
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400 mt-2">Sign in to TaskFlow AI</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button 
                        type="submit" 
                        disabled={loading}
                        className="w-full bg-gradient-to-r from-primary-600 to-primary-500 hover:from-primary-500 hover:to-primary-400 text-white font-bold py-4 rounded-2xl shadow-lg shadow-primary-500/20 transition-all transform hover:scale-[1.02] active:scale-95 disabled:opacity-70 flex items-center justify-center gap-2"
                    >
